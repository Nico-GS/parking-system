...
public final class DBConstants {
    ...
    /**
     * The constant OLD_TICKETS.
     */
    public static final String OLD_TICKETS = "select count(*) as numberVisitsUser from ticket where " + "VEHICLE_REG_NUMBER=? and OUT_TIME is not null"; // is not null
}
