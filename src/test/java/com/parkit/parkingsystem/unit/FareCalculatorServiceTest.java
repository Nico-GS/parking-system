...
public class FareCalculatorServiceTest {
    ...
    public void newUserCalculateFareForOneHour() {
    ...
    public void thirtyMinutesParkingTimeFareEqualToZeroDotSeventyFiveNewUser() {
    ...
    public void thirtyMinutesParkingTimeFareEqualToZeroDotSeventyFiveRecurrentUser() {
        ticket.setOutTime(ticket.getInTime().plusMinutes(30));
        fareCalculatorService.calculateFare(ticket, true);
        assertThat(ticket.getPrice()).isEqualTo((Math.round((0.75 * 0.95 * Fare.CAR_RATE_PER_HOUR) * 100.0) / 100.0));
    }
    ...
    public void thirtyMinutesFreeForNewUser() {
